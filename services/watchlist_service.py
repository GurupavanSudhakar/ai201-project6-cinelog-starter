...
def add_to_watchlist(user_id, film_id, public=None):
    ...
    Args:
        ...
        public (bool, optional): Explicit visibility for this entry. If
            omitted, the model default (private) applies.
    ...
    entry_kwargs = {"user_id": user_id, "film_id": film_id}
    if public is not None:
        entry_kwargs["public"] = public
